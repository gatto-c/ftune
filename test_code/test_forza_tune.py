...
def sum():
    ...
    def result7_l(): return num16 + num15
    # new_percentage_front + anti_roll_bar_only
    result7 = __set_var(MAIN_CALC, 'arbonlyslider', result7_l, 0)

    def hp_per_ton_l(): return int(
        CAR_INPUTS['power_hp']/(CAR_INPUTS['weight']/2240))
    hp_per_ton = __set_var(CAR_INPUTS, 'hp_per_ton',
                           hp_per_ton_l, 0)  # pylint: disable=unused-variable

    result2_l = num3 + num4  # front_percent + overall_balance2
    result2 = __set_var(MAIN_CALC, 'new_percentage_front',
                        result2_l, 0)  # pylint: disable=unused-variable

    def result3_l(): return num3 + (num14 * -1)  # front_percent + -overall_balance
    result3 = __set_var(MAIN_CALC, 'new_percentage_front_neg', result3_l, 0)

    def result4_l(): return round(
        (result7 / (100 - result7) * num5), 2)  # spring_stiffness% x arb%
    ...
    def result6_l(): return round(pow(result7 / (100 - result7), -2) * num5, 2)
    ...
    def result10_l(): return round(num22 + ((num22/100) * num23), 2)
    result10 = __set_var(MAIN_CALC, 'front_rebound_damper',
                         result10_l, 0)  # pylint: disable=unused-variable

    def result11_l(): return round(num24 + ((num24/100) * num23), 2)
    result11 = __set_var(MAIN_CALC, 'rear_rebound_damper',
                         result11_l, 0)  # pylint: disable=unused-variable

    def result12_l(): return round(num25 + ((num25/100) * num23), 2)
    result12 = __set_var(MAIN_CALC, 'front_bump_damper',
                         result12_l, 0)  # pylint: disable=unused-variable

    def result13_l(): return round(num26 + ((num26/100) * num23), 2)
    result13 = __set_var(MAIN_CALC, 'rear_bump_damper2',
                         result13_l, 0)  # pylint: disable=unused-variable

    def result14_l(): return round((num27/100) * num11 + num27, 2)
    result14 = __set_var(MAIN_CALC, 'bias_front_rebound_damper',
                         result14_l, 0)  # pylint: disable=unused-variable

    def result15_l(): return round((num29 / 100) * num12 + num29, 2)
    result15 = __set_var(MAIN_CALC, 'bias_rear_rebound_damper',
                         result15_l, 0)  # pylint: disable=unused-variable

    def result16_l(): return round((num30/100) * num11 + num30, 2)
    result16 = __set_var(MAIN_CALC, 'bias_front_bump_damper',
                         result16_l, 0)  # pylint: disable=unused-variable

    def result17_l(): return round((num31/100) * num12 + num31, 2)
    result17 = __set_var(MAIN_CALC, 'bias_rear_bump_damper2',
                         result17_l, 0)  # pylint: disable=unused-variable

    def result18_l(): return round(
        (math.log(0.667) * (num19) * ((num28)/100) / 32 / 1.5 * -1), 2)
    result18 = __set_var(MAIN_CALC, 'total_front_damping',
                         result18_l, 0)  # pylint: disable=unused-variable

    def result19_l(): return round((math.log(0.667) * (num19) *
                                    ((100 - (num28)) / 100) / 32 / 1.5 * -1), 2)
    result19 = __set_var(MAIN_CALC, 'total_rear_damping2',
                         result19_l, 0)  # pylint: disable=unused-variable

    def result20_l(): return round(num32 / ((num42 / 100) + 1), 2)
    result20 = __set_var(MAIN_CALC, 'front_rebound',
                         result20_l, 0)  # pylint: disable=unused-variable

    def result21_l(): return round((num33 / ((num42 / 100) + 1)), 2)
    result21 = __set_var(MAIN_CALC, 'rear_rebound2',
                         result21_l, 0)  # pylint: disable=unused-variable

    def result22_l(): return round(((num42 / 100) * num22), 2)
    result22 = __set_var(MAIN_CALC, 'front_bump', result22_l,
                         0)  # pylint: disable=unused-variable

    def result23_l(): return round(((num42 / 100) * num24), 2)
    result23 = __set_var(MAIN_CALC, 'rear_bump2', result23_l,
                         0)  # pylint: disable=unused-variable

    def result24_l(): return round(num34, 1)
    result24 = __set_var(MAIN_CALC, 'rear_rebound_results',
                         result24_l, 0)  # pylint: disable=unused-variable

    def result25_l(): return round(num35, 1)
    result25 = __set_var(MAIN_CALC, 'front_rebound_results',
                         result25_l, 0)  # pylint: disable=unused-variable

    def result26_l(): return round(num36, 1)
    result26 = __set_var(MAIN_CALC, 'front_bump_results',
                         result26_l, 0)  # pylint: disable=unused-variable

    def result27_l(): return round(num37, 1)
    result27 = __set_var(MAIN_CALC, 'rear_bump_results',
                         result27_l, 0)  # pylint: disable=unused-variable

    result30 = num6
    MAIN_CALC['front_aero_calculations'] = result30

    def result28_l(): return round(((100 - num16) / num16) * num6, 2)
    ...
    def springresult1_l(): return round((num19 * (result3 / 100) / 64 * 31.193), 1)
    springresult1 = __set_var(
        MAIN_CALC, 'front_springs_calculations', springresult1_l, 0)

    def springresult2_l(): return round(
        (num19 * ((100 - result3) / 100) / 64 * 31.193), 1)
    springresult2 = __set_var(
        MAIN_CALC, 'rear_springs_calculations', springresult2_l, 0)

    def springresult3_l(): return ((springresult1 / 100) * num7) + springresult1
    springresult3 = __set_var(MAIN_CALC, 'spring_stiff_cal_front',
                              springresult3_l, 0)  # pylint: disable=unused-variable

    def springresult4_l(): return (num17 / 100) * num8 + num17
    springresult4 = __set_var(
        MAIN_CALC, 'spring_stiff_cal_rear', springresult4_l, 0)

    def springresult5_l(): return (springresult2 / 100) * num7 + springresult2
    springresult5 = __set_var(MAIN_CALC, 'spring_stiff_cal_front2',
                              springresult5_l, 0)  # pylint: disable=unused-variable

    def springresult6_l(): return (num18 / 100) * num9 + num18
    springresult6 = __set_var(
        MAIN_CALC, 'spring_stiff_cal_rear2', springresult6_l, 0)

    if (unit == 'English'):
        MAIN_CALC['front_springs_results'] = round(num20, 1)
    elif (unit == 'Metric'):
        def springresult7_l(): return round((springresult4) * 0.17858, 1)
        springresult7 = __set_var(MAIN_CALC, 'front_springs_results',
                                  springresult7_l, 0)  # pylint: disable=unused-variable

    if (unit == 'English'):
        MAIN_CALC['rear_springs_results'] = round(num21, 1)
    elif (unit == 'Metric'):
        def springresult8_l(): return round((springresult6) * 0.17858, 1)
        springresult8 = __set_var(MAIN_CALC, 'rear_springs_results',
                                  springresult8_l, 0)  # pylint: disable=unused-variable
    ...
    def finetuneunder1_l(): return round(fronttoe * 0.1, 1)
    finetuneunder1 = __set_var(
        MAIN_CALC, 'adjust_increase_front_toe_out_input2', finetuneunder1_l, 0.0)

    fronttoe3 = MAIN_CALC['front_toe_results']
    def fronttoe4_l(): return round(fronttoe3 + finetuneunder1, 1)
    fronttoe4 = __set_var(
        MAIN_CALC, 'front_toe_fine_tune_results', fronttoe4_l, 0.0)
    ...
    def frontbumpadj_l(): return round((frontbump / 20) * frontbump2, 1)
    frontbumpadj = __set_var(MAIN_CALC, 'adjust_increase_front_bump_damping_input2',
                             frontbumpadj_l, 0.0)  # pylint: disable=unused-variable

    frontbumpres = MAIN_CALC['front_rebound_results']
    finetuneentry = MAIN_CALC['adjust_increase_front_bump_damping_input2']
    def finetuneentry_1(): return frontbumpres + finetuneentry
    finetuneentry = __set_var(
        MAIN_CALC, 'increase_front_bump_damping_ft_res', finetuneentry_1, 0.0)

    casterang = MAIN_CALC['increase_caster_angle_input2']
    def casterangadj_l(): return round(casterang * 0.2, 1)
    casterangadj = __set_var(
        MAIN_CALC, 'adjust_increase_caster_angle_input2', casterangadj_l, 0.0)

    caster2 = MAIN_CALC['front_caster_results']
    def casterangres_l(): return round(caster2 + casterangadj, 1)
    casterangres = __set_var(
        MAIN_CALC, 'front_caster_fine_tune_results', casterangres_l, 0.0)
    ...
    def frontaerres_l(): return round((frontaer / 20) * frontaersl, 0)
    frontaerres = __set_var(
        MAIN_CALC, 'adjust_increase_front_downforce_input2', frontaerres_l, 0.0)

    def frontaerres1_l(): return round((frontaerres + frontaer), 0)
    frontaerres1 = __set_var(
        MAIN_CALC, 'front_aero_fine_tune_results', frontaerres1_l, 0)
    ...
    def frontarbres_l(): return round(((frontarb / 10) * frontarb1), 1)
    frontarbres = __set_var(MAIN_CALC, 'adjust_stiffen_front_arb_input2',
                            frontarbres_l, 0.0)  # pylint: disable=unused-variable

    undermidarb1 = MAIN_CALC['adjust_stiffen_front_arb_input2']
    def frontarbres1_l(): return round((frontarb + undermidarb1), 1)
    frontarbres1 = __set_var(MAIN_CALC, 'stiffen_front_arb_ft_res',
                             frontarbres1_l, 0.0)  # pylint: disable=unused-variable

    frontsp = MAIN_CALC['front_springs_results']
    frontsp1 = MAIN_CALC['increase_front_spring_rate_input2']
    def frontspres_l(): return round(((frontsp / 20) * frontsp1), 1)
    frontspres = __set_var(
        MAIN_CALC, 'adjust_increase_front_spring_rate_input2', frontspres_l, 0.0)

    def frontspres1_l(): return round((frontsp + frontspres), 1)
    frontspres1 = __set_var(MAIN_CALC, 'increase_front_spring_rate_ft_res',
                            frontspres1_l, 0.0)  # pylint: disable=unused-variable

    frontbm = MAIN_CALC['front_bump_results']
    frontbm1 = MAIN_CALC['increase_front_bump_damping2_input2']
    def frontbmres_l(): return round((frontbm / 20) * frontbm1, 1)
    frontbmres = __set_var(MAIN_CALC, 'adjust_increase_front_bump_damping2_input2',
                           frontbmres_l, 0.0)  # pylint: disable=unused-variable

    frontbmres1 = MAIN_CALC['adjust_increase_front_bump_damping2_input2']
    frontbmres3 = MAIN_CALC['front_bump_results']
    def frontbmres2_l(): return round(frontbmres1 + frontbmres3, 1)
    frontbmres2 = __set_var(MAIN_CALC, 'increase_front_bump_damping2_ft_res',
                            frontbmres2_l, 0.0)  # pylint: disable=unused-variable

    frontsft = MAIN_CALC['front_arb_results']
    frontsft1 = MAIN_CALC['soften_front_arb_input2']
    def frontsftres_l(): return round((frontsft / 10) * frontsft1, 1)
    frontsftres = __set_var(MAIN_CALC, 'adjust_soften_front_arb_input2',
                            frontsftres_l, 0.0)  # pylint: disable=unused-variable

    frontsftres1 = MAIN_CALC['stiffen_front_arb_ft_res']
    frontsftres3 = MAIN_CALC['adjust_soften_front_arb_input2']
    def frontsftres2_l(): return round(frontsftres1 + frontsftres3, 2)
    frontsftres2 = __set_var(
        MAIN_CALC, 'soften_front_arb_ft_res', frontsftres2_l, 0.0)
    ...
    def frontsftspres_l(): return round((frontsftsp / 20) * frontsftsp1, 1)
    frontsftspres = __set_var(
        MAIN_CALC, 'adjust_soften_front_spring_rate_input2', frontsftspres_l, 0.0)

    frontsftspres1 = MAIN_CALC['increase_front_spring_rate_ft_res']
    def frontsftspres2_l(): return round(frontsftspres1 + frontsftspres, 1)
    frontsftspres2 = __set_var(
        MAIN_CALC, 'soften_front_spring_rate_ft_res', frontsftspres2_l, 0.0)
    ...
    def frontshstres_l(): return round((frontshst / 20) * frontshst1, 1)
    frontshstres = __set_var(MAIN_CALC, 'adjust_increase_front_shock_stiffness_input2',
                             frontshstres_l, 0.0)  # pylint: disable=unused-variable

    undermid1 = MAIN_CALC['adjust_increase_front_shock_stiffness_input2']
    undermid2 = MAIN_CALC['increase_front_bump_damping_ft_res']
    def frontshstres1_l(): return round(undermid1 + undermid2, 1)
    frontshstres1 = __set_var(MAIN_CALC, 'increase_front_shock_stiffness_ft_res',
                              frontshstres1_l, 0.0)  # pylint: disable=unused-variable

    sliderfrbm = MAIN_CALC['increase_front_shock_stiffness_input']
    def sliderfrbm2_l(): return sliderfrbm * 2
    sliderfrbm2 = __set_var(MAIN_CALC, 'front_bump_slider_input2',
                            sliderfrbm2_l, 0.0)  # pylint: disable=unused-variable

    underst1 = MAIN_CALC['front_bump_results']
    underst2 = MAIN_CALC['front_bump_slider_input2']
    def underst3_l(): return round((underst1 / 20) * underst2, 1)
    underst3 = __set_var(MAIN_CALC, 'adjust_front_bump_slider_input2',
                         underst3_l, 0.0)  # pylint: disable=unused-variable

    underst4 = MAIN_CALC['adjust_front_bump_slider_input2']
    underst46 = MAIN_CALC['increase_front_bump_damping2_ft_res']
    def underst5_l(): return round(underst4 + underst46, 1)
    underst5 = __set_var(
        MAIN_CALC, 'front_bump_slider_input_ft_res', underst5_l, 0.0)
    MAIN_CALC['front_bump_fine_tune_results'] = underst5

    def frontcamres_l(): return (underst9 / 5) * underst7
    frontcamres = __set_var(
        MAIN_CALC, 'adjust_increase_negative_front_wheel_camber_input2', frontcamres_l, 0.0)
    ...
    def underst8_l(round): return (frontcamres + underst9, 1)
    underst8 = __set_var(
        MAIN_CALC, 'increase_negative_front_wheel_camber_ft_res', underst8_l, 0.0)
    ...
    def underst12_l(): return round((underst10 / 20) * underst11, 1)
    underst12 = __set_var(
        MAIN_CALC, 'adjust_reduce_front_rebound_damping_input2', underst12_l, 0.0)

    underst13 = MAIN_CALC['increase_front_shock_stiffness_ft_res']
    def underst14_l(): return round(underst13 + underst12, 1)
    underst14 = __set_var(
        MAIN_CALC, 'reduce_front_rebound_damping_ft_res', underst14_l, 0.0)
    ...
    def ovrstr3_l(): return round((ovrstr1 / 20) * ovrstr2, 1)
    ovrstr3 = __set_var(MAIN_CALC, 'adjust_os_increase_rear_downforce_input2',
                        ovrstr3_l, 0.0)  # pylint: disable=unused-variable

    ovrstr5 = MAIN_CALC['rear_rebound_results']
    ovrstr6 = MAIN_CALC['os_increase_rear_rebound_damping_input2']
    def ovrstr7_l(): return round((ovrstr5 / 20) * ovrstr6, 2)
    ovrstr7 = __set_var(MAIN_CALC, 'adjust_os_increase_rear_rebound_damping_input2',
                        ovrstr7_l, 0.0)  # pylint: disable=unused-variable

    osincreasedf = MAIN_CALC['adjust_os_increase_rear_rebound_damping_input2']
    def ovrstr4_l(): return round(osincreasedf + num43nw, 2)
    ovrstr4 = __set_var(MAIN_CALC, 'os_increase_rear_rebound_damping_ft_res',
                        ovrstr4_l, 0.0)  # pylint: disable=unused-variable

    ovrstr9 = MAIN_CALC['rear_springs_results']
    ovrstr10 = MAIN_CALC['os_increase_rear_spring_rate_input2']
    def ovrstr11_l(): return round((ovrstr9 / 20) * ovrstr10, 1)
    ovrstr11 = __set_var(
        MAIN_CALC, 'adjust_os_increase_rear_spring_rate_input2', ovrstr11_l, 0.0)

    def ovrstr12_l(): return round(ovrstr9 + ovrstr11, 1)
    ovrstr12 = __set_var(MAIN_CALC, 'os_increase_rear_spring_rate_ft_res',
                         ovrstr12_l, 0.0)  # pylint: disable=unused-variable

    ovrstr13 = MAIN_CALC['rear_arb_results']
    ovrstr14 = MAIN_CALC['os_soften_rear_arb_input2']
    def ovrstr15_l(): return round((ovrstr13 / 10) * ovrstr14, 1)
    ovrstr15 = __set_var(
        MAIN_CALC, 'adjust_os_soften_rear_arb_input2', ovrstr15_l, 0.0)

    def ovrstr16_l(): return round(ovrstr13 + ovrstr15, 2)
    ovrstr16 = __set_var(
        MAIN_CALC, 'os_soften_rear_arb_ft_res', ovrstr16_l, 0.0)
    ...
    def ovrstr19_l(): return round((ovrstr17 / 20) * ovrstr18, 1)
    ovrstr19 = __set_var(
        MAIN_CALC, 'adjust_os_soften_rear_spring_rate_input2', ovrstr19_l, 0.0)

    ovrstr20 = MAIN_CALC['os_increase_rear_spring_rate_ft_res']
    def ovrstr21_l(): return round(ovrstr20 + ovrstr19, 1)
    ovrstr21 = __set_var(
        MAIN_CALC, 'os_soften_rear_spring_rate_ft_res', ovrstr21_l, 0.0)
    ...
    def ovrstr24_l(): return round((ovrstr22 / 20) * ovrstr23, 1)
    ovrstr24 = __set_var(MAIN_CALC, 'adjust_os_reduce_rear_shock_stiffness_input2',
                         ovrstr24_l, 0.0)  # pylint: disable=unused-variable

    def downforceadj_l(): return round((ovrstr1 / 20) * ovrstr2, 1)
    downforceadj = __set_var(MAIN_CALC, 'adjust_os_increase_rear_downforce_input2',
                             downforceadj_l, 0.0)  # pylint: disable=unused-variable

    rearaero = MAIN_CALC['rear_aero_results']
    downadjust = MAIN_CALC['adjust_os_increase_rear_downforce_input2']
    def downforceres_l(): return round(rearaero + downadjust, 0)
    downforceres = __set_var(
        MAIN_CALC, 'os_increase_rear_downforce_ft_res', downforceres_l, 0.0)
    MAIN_CALC['rear_aero_fine_tune_results'] = downforceres

    ovrstr25 = MAIN_CALC['os_increase_rear_rebound_damping_ft_res']
    def ovrstr26_l(): return round(ovrstr25 + ovrstr24, 1)
    ovrstr26 = __set_var(
        MAIN_CALC, 'os_reduce_rear_shock_stiffness_ft_res', ovrstr26_l, 0.0)
    MAIN_CALC['rear_rebound_fine_tune_results'] = ovrstr26

    ovrstr27 = MAIN_CALC['os_reduce_rear_shock_stiffness_input']
    def ovrstr28_l(): return ovrstr27 * 2
    ovrstr28 = __set_var(MAIN_CALC, 'front_bump_slider2_input2',
                         ovrstr28_l, 0.0)  # pylint: disable=unused-variable

    ovrstr29 = MAIN_CALC['rear_bump_results']
    ovrstr30 = MAIN_CALC['front_bump_slider2_input2']
    def ovrstr31_l(): return round((ovrstr29 / 20) * ovrstr30, 1)
    ovrstr31 = __set_var(
        MAIN_CALC, 'adjust_front_bump_slider2_input2', ovrstr31_l, 0.0)

    def ovrstr33_l(): return round(num44nw + ovrstr31, 1)
    ovrstr33 = __set_var(
        MAIN_CALC, 'front_bump_slider2_input2_ft_res', ovrstr33_l, 0.0)
    ...
    def ovrstr36_l(): return round(ovrstr34 + ((ovrstr35 / 10) * -1), 1)
    ovrstr36 = __set_var(
        MAIN_CALC, 'os_increase_negative_rear_wheel_camber_ft_res', ovrstr36_l, 0.0)
    MAIN_CALC['rear_camber_fine_tune_results'] = ovrstr36

    ovrstr38 = MAIN_CALC['os_increase_rear_toe_in_input2']
    def ovrstr39_l(): return round(ovrstr38 * 0.1, 1)
    ovrstr39 = __set_var(
        MAIN_CALC, 'os_increase_negative_rear_wheel_camber_ft_res', ovrstr39_l, 0.0)

    ovrstr40 = MAIN_CALC['rear_toe_results']
    def ovrstr41_l(): return round(ovrstr40 - ovrstr39, 1)
    ovrstr41 = __set_var(
        MAIN_CALC, 'os_increase_rear_toe_in_ft_res', ovrstr41_l, 0.0)
    ...
    def ovrstr44_l(): return round((ovrstr42 / 20) * ovrstr43, 1)
    ovrstr44 = __set_var(MAIN_CALC, 'adjust_os_reduce_rear_bump_damping_input2',
                         ovrstr44_l, 0.0)  # pylint: disable=unused-variable
    ...
    def ovrstr46_l(): return round(ovrstr45 + theotherone, 1)
    ovrstr46 = __set_var(
        MAIN_CALC, 'os_reduce_rear_bump_damping_ft_res', ovrstr46_l, 0.0)
    MAIN_CALC['rear_bump_fine_tune_results'] = ovrstr46

    def adjustedratiotop_l(): return num48nw
    adjustedratiotop = __set_var(MAIN_CALC, 'final_adjusted_ratio_top',
                                 adjustedratiotop_l, 0)  # pylint: disable=unused-variable

    def adjustedratiobottom_l(): return num50nw
    adjustedratiobottom = __set_var(MAIN_CALC, 'final_adjusted_ratio_bottom',
                                    adjustedratiobottom_l, 0)  # pylint: disable=unused-variable

    def adjustedratiotopleft_l(): return round(
        (num45nw + ((num45nw / 100) * num23)), 2)
    adjustedratiotopleft = __set_var(
        MAIN_CALC, 'adjusted_ratio_top_left', adjustedratiotopleft_l, 0)  # pylint: disable=unused-variable

    def adjustedratiotopright_l(): return round(
        ((num47nw / 100) * num12 + num47nw), 2)
    adjustedratiotopright = __set_var(
        MAIN_CALC, 'adjusted_ratio_top_right', adjustedratiotopright_l, 0)  # pylint: disable=unused-variable

    def adjustedratiobottomleft_l(): return round(
        (num46nw + ((num46nw / 100) * num23)), 2)
    adjustedratiobottomleft = __set_var(
        MAIN_CALC, 'adjusted_ratio_bottom_left', adjustedratiobottomleft_l, 0)  # pylint: disable=unused-variable

    def adjustedratiobottomright_l(): return round(
        ((num49nw / 100) * num12 + num49nw), 2)
    adjustedratiobottomright = __set_var(
        MAIN_CALC, 'adjusted_ratio_bottom_right', adjustedratiobottomright_l, 0)  # pylint: disable=unused-variable

    divideit = (num56nw / 100)
    addtheone = divideit + 1
    def adjustedsplitrebound_l(): return num55nw / addtheone
    adjustedsplitrebound = __set_var(
        MAIN_CALC, 'adjusted_split_rebound', adjustedsplitrebound_l, 0)  # pylint: disable=unused-variable

    def adjustedsplitbump_l(): return (num56nw / 100) * num45nw
    adjustedsplitbump = __set_var(MAIN_CALC, 'adjusted_split_bump',
                                  adjustedsplitbump_l, 0)  # pylint: disable=unused-variable

    def rearadjustedper_l(): return num42 + num52nw + num54nw
    rearadjustedper = __set_var(MAIN_CALC, 'per_rear_adjustment',
                                rearadjustedper_l, 0)  # pylint: disable=unused-variable

    def usreardampratio_l(): return num51nw * 5
    usreardampratio = __set_var(
        MAIN_CALC, 'adjust_increase_rear_damping_ratio_understeer_input2', usreardampratio_l, 0)
    MAIN_CALC['increase_rear_damping_ratio_understeer_input2_res'] = usreardampratio

    def osreardampratio_l(): return num53nw * 5
    osreardampratio = __set_var(
        MAIN_CALC, 'adjust_decrease_rear_damping_ratio_oversteer_input2', osreardampratio_l, 0)
